...
export const article:IArticle = {
    ...
    ru: {
        ...
        parTwo: 'Погрузитесь в мир моих композиций через музыкальный плеер и позвольте мелодиям унести вас в вихре эмоций и фантазии. Я вложил всю свою страсть и душу в каждый произведенный звук, надеясь вызвать отклик в вашем сердце и принести улыбку на ваше лицо.',
